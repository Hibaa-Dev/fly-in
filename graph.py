...
class Graph:
    ...
    def create_zone(self, mape: Dict[str, Any]) -> None:
        ...
        Args:
            mape: The complete dictionary of parsed map data from the map file.
        """
        self.nb_drones = mape['nb_drones']

        for hub_row in mape['hubs']:
    ...
    def create_conn(self, mape: Dict[str, Any]) -> None:
        ...
        Args:
            mape: The complete dictionary of parsed map data from the map file.
        """
        for conn_rowhub_row in mape['connections']:
            ...
            conn_obj: Connection = Connection(
                ...
                target=trg,
                max_link_capacity=(
                    conn_rowhub_row['metadata']['max_link_capacity'])
            )
